...
export const harvestCount = async ({
  programId,
  timeoutOfCalls,
  fromThisSignature,
  connection,
    ...
    try {
      ...
      for (let signatureInfo of [...newSignatureInfos].reverse()) {
        ...
        const instructionLog =
          currentTransactionInfo.meta.logMessages[1] != 'Program ComputeBudget111111111111111111111111111111 success'
            ? currentTransactionInfo.meta.logMessages[1]
            : currentTransactionInfo.meta.logMessages[3];
