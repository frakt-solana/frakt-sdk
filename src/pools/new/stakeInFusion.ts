...
export const stakeInFusion = async (programId: web3.PublicKey, provider: AnchorProvider, userPublicKey: web3.PublicKey, mintToStake: web3.PublicKey, mintToHarvest: web3.PublicKey, stakeAmount: BN) => {
